  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="page-title">Grievances & Helpdesk</h1>
          <p className="text-gray-500 text-sm">{pagination.total} total</p>
        </div>
        {isEmployee && (
          <button onClick={() => { setForm({ title: '', description: '', category: 'other', priority: 'medium', isAnonymous: false }); setShowModal(true); }} className="btn-primary flex items-center gap-2"><FiPlus className="w-4 h-4" /> Raise Grievance</button>
        )}
      </div>
